...
set out '../../../img/magneto/x04.eps'
set fit errorvariables

data_1up = '../../../dane/magneto/x04/wzdluzna_up.dat'
data_2up = '../../../dane/magneto/x04/poprzeczna_up.dat'
data_1down = '../../../dane/magneto/x04/wzdluzna_down.dat'
data_2down = '../../../dane/magneto/x04/poprzeczna_down.dat'
...
set yrange[-250:450]
set ylabel "{/=28 {/Symbol \l}_{||} [ppm]}" offset -3.35,5
set xtics ('' 0, '' 1, '' 2, '' 3, '' 4, '' 5, '' 6, '' 7, '' 8)
set ytics ('' -250, '-200' -200,'' -150, '-100' -100, '' -50, '0' 0, '' 50,'100' 100, '' 150, '200' 200, '' 250, '300' 300, '' 350, '400' 400,'' 450)  font ",28"
set label 1 at -1.78,-175 '{/=28 {/Symbol l}_{/Symbol \136} [ppm]' rotate left # "{/Symbol \l}_{/Symbol\136} [ppm]}"
...
set yrange [-200:800]
set xtics ('' 0, '' 1, '' 2, '' 3, '' 4, '' 5, '' 6, '' 7, '' 8)
set ytics ('' -200, '0' 0, '200' 200, '400' 400, '600' 600, '' 800)  font ",28"
set ylabel '{/=28{/Symbol l}_{/Symbol t} [ppm]}' offset -4.3,-0.7
...
set yrange [-75:50]
set ytics ('' -75, '-50' -50, '-25' -25, '0' 0, '25' 25, '' 50)  font ",28"
set ylabel '{/=28{/Symbol l}_{V} [ppm]}' offset -4.3,0.2
