...
set out '../../../img/magneto/x02.eps'
set fit errorvariables

data_1up = '../../../dane/magneto/x02/wzdluzna_up.dat'
data_2up = '../../../dane/magneto/x02/poprzeczna_up.dat'
data_1down = '../../../dane/magneto/x02/wzdluzna_down.dat'
data_2down = '../../../dane/magneto/x02/poprzeczna_down.dat'
...
set yrange[-400:600]
set ylabel "{/=28 {/Symbol \l}_{||} [ppm]}" offset -3,5
set xtics ('' 0, '' 1, '' 2, '' 3, '' 4, '' 5, '' 6, '' 7, '' 8)
set ytics ('' -400,'-300' -300, '-200' -200,'-100' -100, '0' 0,'100' 100, '200' 200,'300' 300, '400' 400,'500' 500, '' 600)  font ",28"
set label 1 at -1.79,-300'{/=28 {/Symbol l}_{/Symbol \136} [ppm]' rotate left # "{/Symbol \l}_{/Symbol\136} [ppm]}"
...
set yrange [-200:1000]
set xtics ('' 0, '' 1, '' 2, '' 3, '' 4, '' 5, '' 6, '' 7, '' 8)
set ytics ('' -200, '0' 0, '200' 200, '400' 400, '600' 600, '800' 800, '' 1000)  font ",28"
set ylabel '{/=28{/Symbol l}_{/Symbol t} [ppm]}' offset -3.8,-0.1
...
set yrange [-200:50]
set ytics ('' -200, '-150' -150, '-100' -100, '-50' -50, '0' 0)  font ",28"
set ylabel '{/=28{/Symbol l}_{V} [ppm]}' offset -3,0.2
